...
class EtlRunCycle():  # pylint: disable=too-few-public-methods
    ...
    __tablename__ = 'etlruncycle'

    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    packagename = db.Column(db.String(100))
    runcyclestartdatetime = db.Column(db.DateTime, default=datetime.utcnow)
    runcycleenddatetime = db.Column(db.DateTime, default=datetime.utcnow)

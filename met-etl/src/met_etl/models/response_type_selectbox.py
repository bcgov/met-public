...
class response_type_selectbox(db.Model):  # pylint: disable=too-few-public-methods
    """Definition of the response_type_selectbox entity."""
    ...
    @classmethod
    def get_all(cls):
        """Get all response_type_selectbox."""
        return db.session.query(response_type_selectbox).all()
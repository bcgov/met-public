...
from etl_project.services.jobs.cleanup_old_logs import cleanup_old_logs, vacuum_dagster_db
...
vacuum_dagster_db_schedule = ScheduleDefinition(
    job=vacuum_dagster_db,

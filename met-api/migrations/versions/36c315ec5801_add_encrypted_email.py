...
def upgrade():
    ...
    op.create_foreign_key(None, 'membership', 'staff_users', ['user_id'], ['id'])
...
def downgrade():
    ...
    op.add_column('met_users', sa.Column('tenant_id', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('met_users', sa.Column('external_id', sa.VARCHAR(length=50), autoincrement=False, nullable=False))

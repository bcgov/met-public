...
def upgrade():
    ...
    op.drop_column('engagement_metadata', 'project_id')
...
def downgrade():
    ...
    op.add_column('engagement_metadata', sa.Column('project_metadata', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('engagement_metadata', sa.Column('project_id', sa.VARCHAR(length=50), autoincrement=False, nullable=True))

...
def test_delete_success_without_translation(session, mocker):
    ...
    get_list = mocker.patch(
        'met_api.models.survey_translation.SurveyTranslation.get_survey_translation_list_by_survey_id',
        return_value=[],
    )
    del_tx = mocker.patch(
        'met_api.models.survey_translation.SurveyTranslation.delete_survey_translation',
        return_value=None,
    )

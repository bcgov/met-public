...
from tests.utilities.factory_utils import (
    factory_auth_header, poll_answer_model_with_poll_enagement, factory_poll_answer_translation_model)
...
def test_create_poll_answer_translation(client, jwt, session, setup_admin_user_and_claims):
...
def test_update_poll_answer_translation(client, jwt, session, setup_admin_user_and_claims):
...
def test_delete_poll_answer_translation(client, jwt, session, setup_admin_user_and_claims):

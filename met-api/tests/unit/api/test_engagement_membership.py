...
def test_create_engagement_membership_team_member(mocker, client, jwt, session,
    ...
    mock_assign_composite_role_to_user_keycloak_response = MagicMock()
    mock_assign_composite_role_to_user_keycloak_response.status_code = HTTPStatus.NO_CONTENT
    mock_assign_composite_role_to_user_keycloak = mocker.patch(
        ...
        return_value=mock_assign_composite_role_to_user_keycloak_response
    )

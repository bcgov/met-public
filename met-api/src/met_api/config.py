...
class _Config:  # pylint: disable=too-few-public-methods
    ...
    GC_NOTIFY_CONFIG = {
        "DEFAULT": {
            "VERIFICATION_EMAIL_TEMPLATE_ID": os.getenv(
                "VERIFICATION_EMAIL_TEMPLATE_ID"
            ),
            "VERIFICATION_EMAIL_SUBJECT": os.getenv(
                "VERIFICATION_EMAIL_SUBJECT", "{engagement_name} - Survey link"
            ),
            ...
            "REJECTED_EMAIL_SUBJECT": os.getenv(
                "REJECTED_EMAIL_SUBJECT", "{engagement_name} - About your Comments"
            ),
            "EMAIL_ENVIRONMENT": os.getenv("EMAIL_ENVIRONMENT", ""),
            "ACCESS_REQUEST_EMAIL_TEMPLATE_ID": os.getenv(
                "ACCESS_REQUEST_EMAIL_TEMPLATE_ID"
            ),
            "ACCESS_REQUEST_EMAIL_SUBJECT": os.getenv(
                "ACCESS_REQUEST_EMAIL_SUBJECT", "MET - New User Access Request"
            ),
            "ACCESS_REQUEST_EMAIL_ADDRESS": os.getenv("ACCESS_REQUEST_EMAIL_ADDRESS"),
        },
        "EAO": {
            "VERIFICATION_EMAIL_TEMPLATE_ID": os.getenv(
                "EAO_VERIFICATION_EMAIL_TEMPLATE_ID"
            ),
            "VERIFICATION_EMAIL_SUBJECT": os.getenv(
                "VERIFICATION_EMAIL_SUBJECT", "{engagement_name} - Survey link"
            ),
            ...
            "ENGAGEMENT_CLOSEOUT_EMAIL_TEMPLATE_ID": os.getenv(
                "EAO_ENGAGEMENT_CLOSEOUT"
            ),
            "ENGAGEMENT_CLOSEOUT_EMAIL_SUBJECT": os.getenv(
                "ENGAGEMENT_CLOSEOUT_EMAIL_SUBJECT",
                "The public commenting period for engagement name is now closed.",
            ),
            "EMAIL_ENVIRONMENT": os.getenv("EMAIL_ENVIRONMENT", ""),
            "SUBMISSION_REPORT_ID": os.getenv("EAO_SUBMISSION_REPORT"),
            "SUBMISSION_REPORT_SUBJECT": os.getenv(
                "SUBMISSION_REPORT_SUBJECT", "Your feedback was successfully submitted."
            ),
            "ACCESS_REQUEST_EMAIL_TEMPLATE_ID": os.getenv(
                "ACCESS_REQUEST_EMAIL_TEMPLATE_ID"
            ),
...
class TestConfig(_Config):  # pylint: disable=too-few-public-methods
    ...
    # Legal-API URL
    LEGAL_API_URL = (
        "https://mock-auth-tools.pathfinder.gov.bc.ca/rest/legal-api/2.7/api/v1"
    )

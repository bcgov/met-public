...
class _Config():  # pylint: disable=too-few-public-methods
    ...
    OSS_S3_BUCKET = os.getenv('OSS_S3_BUCKET')
    OSS_S3_ACCESS_KEY_ID = os.getenv('OSS_S3_ACCESS_KEY_ID')
    OSS_S3_SECRET_ACCESS_KEY = os.getenv('OSS_S3_SECRET_ACCESS_KEY')
    OSS_S3_HOST = os.getenv('OSS_S3_HOST')
    OSS_S3_REGION = os.getenv('OSS_S3_REGION')
    OSS_S3_SERVICE = os.getenv('OSS_S3_SERVICE')

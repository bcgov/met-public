...
from met_api.utils.enums import CompositeRoleId, UserStatus
...
class StaffUserMembershipService:
    ...
    def reassign_user(cls, user_id, role, **kwargs):
        ...
        group_id = CompositeRoleId[role].value
        UserGroupMembershipService.reassign_composite_role_to_user({

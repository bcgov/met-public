...
from .suggested_engagement import API as SUGGESTED_ENGAGEMENT_API
...
API.add_namespace(SUGGESTED_ENGAGEMENT_API, path='/engagement/<int:engagement_id>/suggestions')

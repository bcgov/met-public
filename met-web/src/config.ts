...
const FORMIO_PROJECT_URL = process.env.REACT_APP_API_PROJECT_URL;
const FORMIO_API_URL = process.env.REACT_APP_API_SERVER_URL;
const FORMIO_FORM_ID = process.env.REACT_APP_FORM_ID;
const FORMIO_JWT_SECRET = process.env.REACT_APP_FORMIO_JWT_SECRET;
const FORMIO_USER_RESOURCE_FORM_ID = process.env.REACT_APP_USER_RESOURCE_FORM_ID;
const FORMIO_ANONYMOUS_USER = process.env.REACT_APP_FORMIO_ANONYMOUS_USER;
const FORMIO_ANONYMOUS_ID = process.env.REACT_APP_ANONYMOUS_ID;

// Keycloak Environment Variables
const KC_URL = process.env.REACT_APP_KEYCLOAK_URL;
const KC_CLIENT = process.env.REACT_APP_KEYCLOAK_CLIENT;
const KC_REALM = process.env.REACT_APP_KEYCLOAK_REALM;
const KC_ADMIN_ROLE = process.env.REACT_APP_KEYCLOAK_ADMIN_ROLE;

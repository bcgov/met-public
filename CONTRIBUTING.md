...
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ | ------------------------------------------- | --------------------------------------------------------------------------------------- |
| [`Heading1`](met-web/src/components/common/Typography/Headings.tsx#L26)                               | MET-styled h1 component.                                                                                                      | `import { Heading1 } from "components/common/Typography"`                | Level-1 Headings                            | Main titles or headings on pages and sections                                           |
| [`Heading2`](met-web/src/components/common/Typography/Headings.tsx#L55)                               | MET-styled h2 component.                                                                                                      | `import { Heading2 } from "components/common/Typography"`                | Level-2 Headings                            | Subheadings or section titles within a page                                             |
| [`Heading3`](met-web/src/components/common/Typography/Headings.tsx#L104)                              | MET-styled h3 component.                                                                                                      | `import { Heading3 } from "components/common/Typography"`                | Level-3 Headings                            | Smaller section titles or subsections within a page                                     |
| [`Heading4`](met-web/src/components/common/Typography/Headings.tsx#L141)                              | MET-styled h4 component.                                                                                                      | `import { Heading4 } from "components/common/Typography"`                | Level-4 Headings                            | Minor headings or labels within a section                                               |
...
| [`PreviewSwitch`](met-web/src/components/engagement/preview/PreviewSwitch.tsx#L62)                    | A component that conditionally renders its children based on whether the preview mode is active.                              | `import { PreviewSwitch } from "engagements/preview/PreviewSwitch"`      |                                             | In engagement previews, to show placeholder content when real content is not available  |
| [`PreviewRender`](met-web/src/components/engagement/preview/PreviewSwitch.tsx#L35)                    | A component that renders its children with either preview data or real data, based on whether the preview mode is active.     | `import { PreviewRender } from "engagements/preview/PreviewSwitch"`      |                                             | In engagement previews, to render content with preview data when in preview mode        |
| [`PreviewValue`](met-web/src/components/engagement/preview/PreviewSwitch.tsx#L21)                     | A component renders either a preview value or a real value, based on whether the preview mode is active.                      | `import { PreviewValue } from "engagements/preview/PreviewValue"`        |                                             | In engagement previews, to render a value with preview data when in preview mode        |
| [`TextPlaceholder`](met-web/src/components/engagement/preview/placeholders/TextPlaceholder.tsx#L14)   | Displays placeholder text with an underline and hover effect to distinguish it from real content                              | `import { TextPlaceholder } from "engagements/preview/placeholders"`     |                                             | In engagement previews, to show placeholder text when real content is not available     |
